...
<@clo.pages
    ...
    <div class="switching-clnOptics">
        ...
        <p class="p-none-a" style="opacity: 1;">ПОШУК</p>
    </div>

    <div class="title-clnOptics">
        <p id="group-display">Сонцезахисні окуляри та оправи</p>
    </div>
    ...
    <div class="row row-cols-2 row-cols-md-4 g-4 custom-margin-left all-optics1" id="all-optics-byGroup"
     style="width: 92%; margin-bottom: calc(100vw * 40 / 1366);">
        <#if allOpticsBySearch??>
            <#list 0..(allOpticsBySearch?size - 1) as i>
            <#if allOpticsBySearch[i]?exists>
                <#assign optic = allOpticsBySearch[i]>
    ...
    <script src="/js/catalog_optics/catalog_optics_by_search.js"></script>
