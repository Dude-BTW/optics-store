<#--
  CATEGORY CATALOG PAGE: Renders a grid of product cards filtered by a specific optical group.
  Features a robust Faceted Search mechanism (dynamic filtering sidebar) and sorting options as
  described in the architecture. Handles dynamic DOM updates when filtering parameters change.
-->
...
<@clo.pages
    ...
    <div id="photoCarousel" class="carousel slide">
        <div class="carousel-inner" style="height: calc(100vw * 400 / 1366);">
            <div class="carousel-item active">
                <img src="${logoGroup}" class="d-block w-100 carousel-item carousel-inner-img" alt="Selected Logo" style="height: calc(100vw * 400 / 1366); object-fit: cover;">
            </div>
        </div>
    </div>
    ...
    <div class="switching-clnOptics">
        ...
        <p class="p-none-a" style="opacity: 1;">${groupName?upper_case}<#if groupGender??>&nbsp;${groupGender?upper_case}</#if></p>
    </div>

    <div class="title-clnOptics">
        <p id="group-display">${groupName?cap_first}<#if groupGender??>&nbsp;${groupGender}</#if></p>
    </div>

    <div class="dropdown1-feedback" style="margin-bottom: calc(100vw * 24 / 1366); margin-top: calc(100vw * 0 / 1366);">
        <button class="open-popup-filter2">
    ...
    <div class="row row-cols-2 row-cols-md-4 g-4 custom-margin-left all-optics1" id="all-optics-byGroup"
     style="width: 92%; margin-bottom: calc(100vw * 40 / 1366);">
        <#if allOpticsByGroup??>
            <#list 0..(allOpticsByGroup?size - 1) as i>
            <#if allOpticsByGroup[i]?exists>
                <#assign optic = allOpticsByGroup[i]>
                ...
                <div class="col card-byGroup<#if (i > 27)> hidden-line</#if>" style="flex: 0 0 auto;"
    ...
    <script>
        <#if groupGender??>
            const groupGenderJS = " ${groupGender}";
        <#else>
            const groupGenderJS = "";
        </#if>
    </script>
    ...
    <script src="/js/catalog_optics/catalog_optics_by_group.js"></script>
