<#--
  VIEWED PRODUCTS HISTORY: Implements the tracking mechanism for recently viewed items.
  Renders a horizontal product carousel based on the user's browsing history (saved state),
  allowing users to revisit previously explored catalog items seamlessly.
-->
<div class="no-wrap-row-controls" id="${prefix}_no-wrap-row-controls"
    style="margin-bottom: calc(100vw * -32 / 1366);
        margin-top: calc(100vw * 0 / 1366);
        margin-left: 5.8%;">
Товари, які ви переглядали</div>

<div id="${prefix}_viewed-optics" style="margin-bottom: calc(100vw * 2.5 / 1366);">
    <div class="carousel-controls" style="margin-top: calc(100vw * 0 / 1366);" id="${prefix}_carouselСontrols">
        <button id="${prefix}_carouselPrev2" class="btn carousel-prev-1">
            <img src="/images/System_Interface/carousel_symbols/carousel_prev.svg" alt="Previous" style="width: calc(100vw * 29 / 1366);
                                                                                                         height: calc(100vw * 29 / 1366);">
        </button>
        <button id="${prefix}_carouselNext2" class="btn carousel-next-1">
            <img src="/images/System_Interface/carousel_symbols/carousel_next.svg" alt="Next" style="width: calc(100vw * 29 / 1366);
                                                                                                     height: calc(100vw * 29 / 1366);">
        </button>
    </div>

    <div class="row no-wrap-row row-cols-2 row-cols-md-5 custom-margin-left all-optics2 all-optics-m5 all-optics-viewed" id="${prefix}_all-optics2">
        <#if allOptics??>
            <#list allOptics as optic>
                <div class="col" id="optic-a-col_${idToTokenOpticsMap[optic.id?string]}" style="display: none;">
    ...
    <button id="clear-viewed-optics" class="btn">Очистити переглянуті товари</button>
</div>
