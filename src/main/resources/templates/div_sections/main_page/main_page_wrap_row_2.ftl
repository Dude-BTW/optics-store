<div class="carousel-controls">
    <button id="${prefix}_carouselPrev2" class="btn carousel-prev-2">
    ...
    <button id="${prefix}_carouselNext2" class="btn carousel-next-2">
...
<div class="row no-wrap-row row-cols-2 row-cols-md-4 g-4 custom-margin-left all-optics2" id="${prefix}_all-optics2">
    <#if allOptics2??>
        <#list allOptics2 as optic>
            <div class="col">
                <div class="card h-100 position-relative">
                    ...
                    <div class="custom-card">
                        ...
                        <div class="non-selectable productContainer" id="${prefix}_rating-productContainer_${idToTokenOpticsMap[optic.id?string]}">
                            ...
                            <div class="non-selectable numberOptics" id="${prefix}_numberOptics_${idToTokenOpticsMap[optic.id?string]}">${rating.numberOpticIds}</div>
                        </div>
