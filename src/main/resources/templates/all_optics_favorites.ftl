<#--
  WISHLIST (FAVORITES) PAGE: Renders a grid of product cards that the user has explicitly marked
  as favorite. Includes interactive components like 'Add to Cart' and real-time availability status
  checks. Interacts with local storage or server session to track user preferences.
-->
...
<@clo.pages
    ...
    <div class="switching-pages">
        ...
        <p class="p-none-a">ВПОДОБАНI ТОВАРИ</p>
    </div>

    <p class="optics-favorites-title">Обрані товари</p>

    <div class="row row-cols-2 row-cols-md-4 g-4 all-optics-favorites">
        <#if allOptics??>
            <#list allOptics as optic>
                <div class="col" id="optic-favorites-col_${idToTokenOpticsMap[optic.id?string]}" style="display: none;">
                    <div class="card h-100 position-relative">
                        ...
                        <div class="custom-card d-flex flex-column">
                            ...
                            <div class="non-selectable productContainer" id="row1_rating-productContainer_${idToTokenOpticsMap[optic.id?string]}">
                                <div class="productSkills" id="row1_productSkills_${idToTokenOpticsMap[optic.id?string]}">
                                ...
                                <div class="non-selectable numberOptics" id="row1_numberOptics_${idToTokenOpticsMap[optic.id?string]}">
                            ...
                            <script>
                                ...
                                applyRating(`row1_rating-productContainer_${opticId}`, ${checkedStar});
                            </script>
                            ...
                            <div class="custom-body">
                                ...
                                <#if optic.opticsAddition.action != 0>
                                    ...
                                    <div class="price-with-action-info" id="row1_price-with-action-info_${idToTokenOpticsMap[optic.id?string]}">
