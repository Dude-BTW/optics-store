 ...
 */
public interface RatingGlobalRepos extends JpaRepository<RatingGlobal, Long> {
    /**
     ...
     * mechanisms.
     */
    Optional<RatingGlobal> findFirstByClientIdAndAccountUsedAndIsVisibleFalse(Long clientId, Boolean accountUsed);
}
