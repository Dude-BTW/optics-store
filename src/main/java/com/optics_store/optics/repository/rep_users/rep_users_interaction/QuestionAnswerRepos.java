 ...
 */
public interface QuestionAnswerRepos extends JpaRepository<QuestionAnswer, Long> {
    /**
     ...
     * mechanisms.
     */
    Optional<QuestionAnswer> findFirstByClientIdAndAccountUsedAndIsVisibleFalse(Long clientId, Boolean accountUsed);
}
